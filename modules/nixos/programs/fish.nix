...
# Changes:
# - removed dependency on documentation.man.cache.generateAtRuntime
# - removed dependency on config.documentation.nixos.enable
{
  config,
  lib,
  pkgs,
...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    # Not supported in devcontainers.
          ...
          let
            ...
            generateCompletions =
              ...
              pkgs.runCommandLocal
                ...
                '';
            packages =cfge.systemPackages ++ cfg.extraCompletionPackages;
          in
          pkgs.buildEnv {
